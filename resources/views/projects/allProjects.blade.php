...
@section('header')
    @php $urls = array( array('name'=> 'خانه', 'url' => url('/')) , array('name'=> 'پروژه ها' , 'url' => null)) @endphp
        ...
        <tr>
            ...
            <td>{{$project->getMeta('safe_zone')}}</td>
                <td>
                    ...
                    <a href="{{route('showLiquids' ,$project->id)}}"><button class="btn btn-primary" type="submit">مایعات</button></a>
