...
@section('content')
    ...
    @endif
    <a href="{{route('createLiquid' , $id)}}"><button class="btn btn-primary mb-4" type="submit">ایجاد مایع</button></a>
        ...
        @foreach ($liquids as $liquid)
            <tr>
              ...
              <td>{{$liquid->density;}}</td>
                <td>
                    <a href="{{route('editLiquid' , $liquid->id)}}"><button class="btn btn-primary" type="submit">ویرایش</button></a>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a  href="{{route('deleteLiquid' , $liquid->id)}}"><button class="action-btn btn btn-danger" type="submit">حذف</button></a>
                                </div>
                            </div>
                        </div>
                    </div>
