...
@section('content')
    ...
    <div class="card card-primary">
        ...
        <!-- /.card-header -->
        <!-- form start -->
        <form role="form" action="{{route('checkEditLiquid' , $liquid->id)}}" method="POST" >
            @csrf
            <div class="card-body">
                <div class="form-group has-error">
                    <input id="project_id" type="hidden" class="form-control @error('project_id') is-invalid @enderror" name="project_id" value="{{$liquid->project_id}}"  aria-label="Small" aria-describedby="inputGroup-sizing-sm">
                    @error('project_id')
            ...
            <div class="card-footer">
                ...
                <a class="btn btn-danger" href="{{route('showLiquids' , $liquid->project_id)}}">انصراف</a>
            </div>
        </form>
    </div>
    <!-- /.card -->
