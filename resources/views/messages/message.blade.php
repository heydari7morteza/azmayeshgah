                  ...
                  @foreach ($messages as $message)
                    <div class="direct-chat-msg">
                      <div class="direct-chat-info clearfix">
                        ...
                        <span class="direct-chat-timestamp float-right">{{\Morilog\Jalali\Jalalian::forge($message->created_at)->format('%d/ %m/ %Y')}}</span>
                      </div>
                      <!-- /.direct-chat-info -->
                      <!-- /.direct-chat-img -->
                  ...
                  @foreach ($messages as $message)
                    <div class="direct-chat-msg right">
                      <div class="direct-chat-info clearfix">
                        ...
                        <span class="direct-chat-timestamp float-left">{{\Morilog\Jalali\Jalalian::forge($message->created_at)->format('%d/ %m/ %Y')}}</span>
                      </div>
                      <!-- /.direct-chat-info -->
